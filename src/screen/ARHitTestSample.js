...
import { ViroARScene, ViroAmbientLight, ViroNode, ViroQuad, Viro3DObject, } from '@viro-community/react-viro'

import TimerMixin from 'react-timer-mixin';

var createReactClass = require('create-react-class');
var coffee_mug = [
    require('./../res/coffee_mug/coffee_mug_diffuse.png'),
    require('./../res/coffee_mug/coffee_mug_specular.png')
];
var object_flowers = [
    ...
    _getModel() {
        ...
        modelArray.push(<ViroNode
            ...
            <Viro3DObject
                ...
                resources={this.props.arSceneNavigator.viroAppProps.index == 2 ? emoji_smile : this.props.arSceneNavigator.viroAppProps.index == 1 ? object_flowers : coffee_mug}
